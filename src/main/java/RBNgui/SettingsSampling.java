...
public class SettingsSampling extends JFrame implements ActionListener, ItemListener, KeyListener{
	 ...
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
	private JPanel logpanel = new JPanel(new GridLayout(3,1));
	/**
	...
	public SettingsSampling(final InferenceModule evidence){
		...
		textcptparents.addKeyListener(this);
		...
		textnumsubsamples_minmax.addKeyListener(this);
		textnumsubsamples_minmax.setText(""+evidence.getNumSubsamples_minmax());
		textnumsubsamples_adapt.addKeyListener(this);
		...
		this.setTitle("Settings Importance Sampling");
	...
	public void actionPerformed( ActionEvent e ) {
		...
		if( source == fileButton ){
			int value = fileChooser.showDialog(SettingsSampling.this, "Select");

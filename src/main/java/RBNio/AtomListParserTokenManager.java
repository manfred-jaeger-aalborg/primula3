/* Generated By:JavaCC: Do not edit this line. AtomListParserTokenManager.java */
package RBNio;
import RBNpackage.*;
import java.util.*;

/** Token Manager. */
public class AtomListParserTokenManager implements AtomListParserConstants
{
...
/** Constructor. */
public AtomListParserTokenManager(SimpleCharStream stream){
...
/** Constructor. */
public AtomListParserTokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}

...
private int jjMoveStringLiteralDfa3_0(long old0, long active0){
   ...
   switch(curChar)
   {
      case 101:
         if ((active0 & 0x1000000L) != 0L)
            return jjStartNfaWithStates_0(3, 24, 253);
         break;
      case 115:
...
private int jjMoveStringLiteralDfa4_0(long old0, long active0){
   ...
   switch(curChar)
   {
      case 101:
         if ((active0 & 0x2000000L) != 0L)
            return jjStartNfaWithStates_0(4, 25, 253);
         break;
      default :
         break;
   }
...
private int jjMoveNfa_0(int startState, int curPos)
{
   ...
   for (;;)
   {
      ...
      ++curPos;
      if ((i = jjnewStateCnt) == (startsAt = 499 - (jjnewStateCnt = startsAt)))
         return curPos;
      try { curChar = input_stream.readChar(); }
...
null, null, null, null, null, null, "\52", "\53", "\55", "\76", "\74", null, null, };
...
static final int[] jjnextStates = {
   57, 58, 59, 61, 62, 102, 103, 464, 469, 484, 498, 394, 398, 409, 419, 429, 
   438, 448, 457, 352, 353, 356, 358, 362, 365, 377, 388, 334, 336, 343, 349, 300, 
   302, 310, 317, 324, 330, 264, 271, 280, 288, 296, 242, 251, 202, 213, 223, 233, 
   181, 196, 167, 174, 144, 147, 151, 163, 136, 141, 116, 119, 127, 134, 107, 113, 
   95, 99, 84, 90, 70, 77, 
};
...
static final long[] jjtoMore = {
   0x100L, 
    ...
    private final int[] jjrounds = new int[499];
    private final int[] jjstateSet = new int[2 * 499];

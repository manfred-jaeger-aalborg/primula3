/* Generated By:JavaCC: Do not edit this line. RBNParser2TokenManager.java */
package RBNio;
import RBNpackage.*;
import java.util.*;
...
/** Token Manager. */
public class RBNParser2TokenManager implements RBNParser2Constants
{
...
/** Constructor. */
public RBNParser2TokenManager(SimpleCharStream stream){
...
/** Constructor. */
public RBNParser2TokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
